<x-layouts.public title="Cart - BricoMag">
    <section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex flex-wrap items-end justify-between gap-4">
            ...
            <a class="rounded-md border border-zinc-300 px-4 py-2 font-semibold hover:border-emerald-700 hover:text-emerald-700"
        ...
        @if ($items->isEmpty())
            <div class="rounded-lg border border-zinc-200 bg-white p-8 text-zinc-600">
        ...
        <div class="grid gap-8 lg:grid-cols-[1fr_360px]">
                ...
                @foreach ($items as $item)
                    ...
                    @php
                        ...
                        $image = $product->image_path
                            ? (str_starts_with($product->image_path, 'http')
                                ? $product->image_path
                    ...
                    <article class="grid gap-4 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm sm:grid-cols-[120px_1fr]">
                        ...
                        <img class="h-28 w-full rounded-md object-contain bg-white"
                             src="{{ $image }}"
                             alt="{{ $product->name }}">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-wrap items-center gap-3">
                                ...
                                {{-- UPDATE FORM (AUTO SUBMIT) --}}
                                <form method="POST"
                                      action="{{ route('cart.update', $product) }}"
                                      class="js-cart-form flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        value="{{ $item['quantity'] }}"
                                        class="w-24 rounded-md border border-zinc-300 px-3 py-2"
            ...
            <aside class="h-fit rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
                ...
                <a href="{{ route('cart.processing') }}"
                   class="mt-6 block rounded-md bg-emerald-700 px-5 py-3 text-center font-semibold text-white hover:bg-emerald-800">
